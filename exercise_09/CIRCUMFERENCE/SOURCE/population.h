...
private:
  ...
  double _prob_crossover, _prob_mutation_shift, _prob_mutation_inversion, _prob_mutation_swap_blocks, _prob_permutation; // probabilities of crossover and mutation
