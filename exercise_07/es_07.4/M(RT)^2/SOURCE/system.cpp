...
void System :: measure(){ // Measure properties
  ...
  if (_measure_gofr){
    ...
    for (int i = 0; i < _n_bins; ++i) {
      ...
      _measurement(_index_gofr + i) = double(gofr_temp[i]) / (normalization ); 
    }
  }
  ...
  if (_measure_pressure) { 
    ...
    if (_sim_type == 1) _measurement[_index_pressure] = _rho * _temp + (_ptail*_npart + 48.0*virial/3.0)/_volume;} // add ideal gas contribution
  // MAGNETIZATION /////////////////////////////////////////////////////////////
// TO BE FIXED IN EXERCISE 6
  // SPECIFIC HEAT /////////////////////////////////////////////////////////////
// TO BE FIXED IN EXERCISE 6
